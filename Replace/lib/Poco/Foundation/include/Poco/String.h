	...
	/// whitespace removed.
{
	...
	while (it != end && Poco::isspace(*it)) ++it;
	return S(it, end);
}
	...
	/// whitespace removed.
{
	...
	while (pos >= 0 && Poco::isspace(str[pos])) --pos;
	...
	/// trailing whitespace removed.
{
	...
	while (first <= last && Poco::isspace(str[first])) ++first;
	while (last >= first && Poco::isspace(str[last])) --last;
	...
	/// Returns a copy of str containing all upper-case characters.
{
	...
	while (it != end) result += Poco::toupper(*it++);
	return result;
}
	...
	/// Replaces all characters in str with their upper-case counterparts.
{
	...
	while (it != end) { *it = Poco::toupper(*it); ++it; }
	return str;
}
	...
	/// Returns a copy of str containing all lower-case characters.
{
	...
	S result;
	result.reserve(str.size());
	while (it != end) result += Poco::tolower(*it++);
	return result;
}
	...
	/// Replaces all characters in str with their lower-case counterparts.
{
	...
	while (it != end) { *it = Poco::tolower(*it); ++it; }
	return str;
}
	...
	/// Case-insensitive string comparison
{
	...
	{
        typename S::value_type c1(Poco::tolower(*it1));
        typename S::value_type c2(Poco::tolower(*it2));
        if (c1 < c2)
            return -1;
        else if (c1 > c2)
            return 1;
	...
	const typename S::value_type* ptr)
{
	...
	while (it != end && *ptr)
	{
        typename S::value_type c1(Poco::tolower(*it));
        typename S::value_type c2(Poco::tolower(*ptr));
        if (c1 < c2)
            return -1;
        else if (c1 > c2)
            return 1;
